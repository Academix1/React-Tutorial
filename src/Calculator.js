...
const Calculator = () => {
    ...
    const handleMultiplication = () => {
        if (!validateInputs()) return;
        const Multipliation = parseFloat(numbers.num1) * parseFloat(numbers.num2);
        setResult(Multipliation);
        setSuccess('Multipliation done successfully!');
        setError('');
    };
    ...
    const handleDivi = () => {
        ...
        setResult(Division);
        setSuccess('Division done successfully!');
        setError('');
    };
